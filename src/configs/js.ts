...
export const jsEslintConfig = (options: JsEslintConfigOptions = {}): FlatConfigEntry[] => {
  const javascriptConfig: FlatConfigEntry<BuiltinEslintRules> = {
    ...
    rules: {
      ...
      'no-multi-str': ERROR,
      'no-negated-condition': ERROR, // TODO check unicorn version
