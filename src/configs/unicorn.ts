...
import {disableAutofixForRule} from '../utils';
  ...
  return [
...

    {
      ...
      rules: {
        ...
        // TODO check for "engines.node" field? See https://github.com/sindresorhus/eslint-plugin-unicorn/blob/1deb9bb5edf27fdb2f656add11c924dfa59fdac9/docs/rules/prefer-node-protocol.md
